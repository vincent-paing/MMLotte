...
import com.mmlotte.lottery.domain.interactor.CompletableUseCase
 ...
 */
class UpdateConsentStatusForCrashLog @Inject constructor(
  private val consentRepository: ConsentRepository,
  postExecutionThread: PostExecutionThread,
  threadExecutor: ThreadExecutor
) : CompletableUseCase<Boolean>(postExecutionThread, threadExecutor) {

  override fun provideCompletable(params: Boolean): Completable {
    return consentRepository.updateConsentStatusForLoggingCrash(params)
  }
