...
class GetConsentStatusForAd @Inject constructor(
  private val consentRepository: ConsentRepository,
  postExecutionThread: PostExecutionThread,
  threadExecutor: ThreadExecutor
) : SingleUseCase<Boolean, Unit>(postExecutionThread, threadExecutor) {

  override fun provideSingle(params: Unit): Single<Boolean> {
    return consentRepository.getConsentStatusForAd()
  }
}