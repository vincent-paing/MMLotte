...
import kotlinx.android.synthetic.main.dialog_ad.btnNo
import kotlinx.android.synthetic.main.dialog_ad.btnYes
import kotlinx.android.synthetic.main.dialog_ad.tvPrivacyPolicy

/**
 * Created by Vincent on 8/20/18
 */
class AdMobConsentDialog : DialogFragment() {
  ...
  companion object {
    ...
    fun newInstance(consentListener: ConsentListener, privacyPolicyUrl: String? = null)
        : AdMobConsentDialog {
      val fragment = AdMobConsentDialog()
      fragment.consentListener = consentListener
      if (privacyPolicyUrl != null) {
        val bundle = Bundle()
        bundle.putString(ARG_PRIVACY_POLICY, privacyPolicyUrl)
  ...
  interface ConsentListener {
    fun onConsent(allowPersonalized: Boolean)
  }
  ...
  override fun onCreateView(
    ...
    val rootView = inflater.inflate(R.layout.dialog_ad, container, false)
    return rootView!!
  }
