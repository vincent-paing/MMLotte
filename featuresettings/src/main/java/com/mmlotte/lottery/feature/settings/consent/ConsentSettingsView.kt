 ...
 */
interface ConsentSettingsView : Viewable {

  fun subscribeToCrashLogConsentLiveData(liveData: LiveData<Boolean>)

  fun subscribeToAdConsentLiveData(liveData: LiveData<Boolean>)
